...
try{
	...
	$lead = $api_connector->create(array(
		'name'			=> $_POST['name'],
		'phone'			=> $_POST['phone'],
		'offer_id'		=> '2811',                         // offer_id из ЛК
		'stream_id'		=> '',                         // Optional, stream_id 
		'country' 		=> 'CZ',                            // Country in format https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2
		'tz' 			=> '',
		'address' 		=> '',
...
{
    public $config = array(
        'api_key' => '51a7146a5f27616bc4b307ae36d6cfb6',                                     		// api_key of user
        'user_id' =>  '5108',                                                              		// user_id
